---
type: note
created: '2026-01-08T12:50:36.462Z'
---
...
- Regex change: Split on whitespace and forward slash
...
2. **ORP Font Weight Removed**
   - Changed from bold (font-weight: 600) to normal
   - Red color is sufficient for focus
